...
- (instancetype)init
{
    ...
    if (self) {
        ...
        toastLabel.backgroundColor = [UIColor colorWithWhite:0.0 alpha:0.9];
        toastLabel.cornerRadius = 7;
...
//    [BHUD dismissHud];
    ...
    [myWindow addSubview:toastLabel];
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.font = [UIFont fontWithName:@"Heiti SC" size:15];
    }
    return self;
}
...
- (void)setMessageText:(NSString *)text{
    ...
    CGRect rect = [self.text boundingRectWithSize:CGSizeMake(DeviceWidth-40, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:self.font} context:nil];
    
    CGFloat width = rect.size.width + 20;
    CGFloat height = rect.size.height + 20;
    CGFloat x = (DeviceWidth-width)/2;
    CGFloat y = (DeviceHeight-height)/2.0;
