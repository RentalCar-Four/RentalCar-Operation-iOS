...
@synthesize borderType = _borderType;//线段样式
@synthesize cornerRadius = _cornerRadius;//线段圆角
@synthesize borderWidth = _borderWidth;//线段宽度
@synthesize dashPattern = _dashPattern;//线段长度
@synthesize spacePattern = _spacePattern;//线段间隔
@synthesize borderColor = _borderColor;//线段颜色
