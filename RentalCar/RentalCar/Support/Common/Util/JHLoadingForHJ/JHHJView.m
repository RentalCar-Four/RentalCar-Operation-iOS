...
+ (JHHJView *)shareInstanceJHHJView{
    ...
    if (!instance) {
        ...
        instance.frame = CGRectMake(0, 0, kScreenWidth, kScreenHeight);
        instance.centerBGView        = [[JHHJCenterBGView alloc] initWithFrame:CGRectMake(0, 0, 100, 100)];
        instance.centerBGView.center = CGPointMake(kScreenWidth/2, instance.height/2);
...
- (CALayer *)lineAnimation{
    ...
    shape.fillColor               = kBlueColor.CGColor;
