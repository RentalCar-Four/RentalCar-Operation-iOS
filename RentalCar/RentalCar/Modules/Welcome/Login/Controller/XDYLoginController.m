...
- (void)backAction {
    [self dismissViewControllerAnimated:YES completion:^{
        BaseNavController *nav =  (BaseNavController *)[APPUtil getCurrentVC];
//        NSLog(@"%@",nav);
        if ([nav isKindOfClass:[BaseNavController class]]) {
            [nav popToRootViewControllerAnimated:YES];
        }else if ([nav.navigationController isKindOfClass:[UINavigationController class]]){
