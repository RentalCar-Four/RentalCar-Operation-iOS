...
- (void)setResizableClipArea:(BOOL)resizableClipArea {
    ...
    if (!resizableClipArea) {
        self.clipView.frame = CGRectMake(0, 0, kScreen_Width, KScreen_Height - NVBarAndStatusBarHeight);
    }
}
...
- (UIToolbar *)bottomBar {
    if (_bottomBar == nil) {
        _bottomBar = [[UIToolbar alloc]initWithFrame:CGRectMake(0, KScreen_Height - NVBarAndStatusBarHeight, kScreen_Width, NVBarAndStatusBarHeight)];
